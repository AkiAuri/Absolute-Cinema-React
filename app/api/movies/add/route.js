...
export async function POST(request) {
    try {
        ...
        // 1. Fetch real movie data from TMDB securely on the backend
    ...
    `).bind(
        ...
        // Return the formatted movie so the frontend can display it immediately
        const newMovie = {
            id: movieData.id,
